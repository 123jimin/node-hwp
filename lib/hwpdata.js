...
root.record.SHAPE_COMPONENT = function Record_SHAPE_COMPONENT(data){
	...
	break;
	case "$rec": case "$lin": case "$ell": case "$col":
	console.log(bufferToString(this.data.slice(offset.value)));
	this.attr.LineShape = {};
	...
	this.attr.FillBrush.Gradation.StepCenter=this.data.readUInt16LE(offset.value); offset.value+=2;
	break;
	default:
