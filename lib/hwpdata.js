...
root.record.CHAR_SHAPE = function Record_CHAR_SHAPE(data){
	...
	for(var ii1=0;ii1<7;ii1++){
		this.attr._FontIDs[ii1] = {};
		this.attr._FontIDs[ii1].value=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
	this.attr._FontRatios=[];
	for(var ii2=0;ii2<7;ii2++){
		this.attr._FontRatios[ii2] = {};
		this.attr._FontRatios[ii2].value=this.data.readUInt8(offset.value); offset.value+=1;
	}
	this.attr._FontCharSpacings=[];
	for(var ii3=0;ii3<7;ii3++){
		this.attr._FontCharSpacings[ii3] = {};
		this.attr._FontCharSpacings[ii3].value=this.data.readInt8(offset.value); offset.value+=1;
	}
	this.attr._FontRelSizes=[];
	for(var ii4=0;ii4<7;ii4++){
		this.attr._FontRelSizes[ii4] = {};
		this.attr._FontRelSizes[ii4].value=this.data.readUInt8(offset.value); offset.value+=1;
	}
	this.attr._FontCharOffsets=[];
	for(var ii5=0;ii5<7;ii5++){
		this.attr._FontCharOffsets[ii5] = {};
		this.attr._FontCharOffsets[ii5].value=this.data.readInt8(offset.value); offset.value+=1;
	}
...
root.record.NUMBERING = function Record_NUMBERING(data){
	...
	for(var ii6=0;ii6<7;ii6++){
		this.attr.ParaHeads[ii6] = {};
		tmp=this.data.slice(offset.value,(offset.value+4)); offset.value+=4;
	this.attr.ParaHeads[ii6].Alignment=(tmp[0]&0x3);if(root.enum.AlignmentType2[this.attr.ParaHeads[ii6].Alignment]!==undefined)this.attr.ParaHeads[ii6].Alignment=root.enum.AlignmentType2[this.attr.ParaHeads[ii6].Alignment];
	this.attr.ParaHeads[ii6].UseInstWidth=!!((tmp[0]&0x4)>>2);
	this.attr.ParaHeads[ii6].AutoIndent=!!((tmp[0]&0x8)>>3);
	this.attr.ParaHeads[ii6].TextOffsetType=((tmp[0]&0x10)>>4);if(root.enum.TextOffsetType[this.attr.ParaHeads[ii6].TextOffsetType]!==undefined)this.attr.ParaHeads[ii6].TextOffsetType=root.enum.TextOffsetType[this.attr.ParaHeads[ii6].TextOffsetType];
	this.attr.ParaHeads[ii6].NumFormat=((tmp[0]&0xe0)>>5)+((tmp[1]&0x1)<<3);if(root.enum.NumberType1[this.attr.ParaHeads[ii6].NumFormat]!==undefined)this.attr.ParaHeads[ii6].NumFormat=root.enum.NumberType1[this.attr.ParaHeads[ii6].NumFormat];
		this.attr.ParaHeads[ii6].WidthAdjust=this.data.readUInt16LE(offset.value); offset.value+=2;
		this.attr.ParaHeads[ii6].TextOffset=this.data.readUInt16LE(offset.value); offset.value+=2;
		this.attr.ParaHeads[ii6].CharShape=this.data.readUInt32LE(offset.value); offset.value+=4;
		tmp=this.data.readUInt16LE(offset.value); offset.value+=2;for(this.attr.ParaHeads[ii6].value='';tmp-->0;){this.attr.ParaHeads[ii6].value+=String.fromCharCode(this.data.readUInt16LE(offset.value)); offset.value+=2;}
	}
...
root.record.PARA_RANGE_TAG = function Record_PARA_RANGE_TAG(data){
	...
	for(var ii7=0;offset.value<this.data.length;ii7++){
		this.attr._Data[ii7] = {};
		this.attr._Data[ii7].start=this.data.readUInt32LE(offset.value); offset.value+=4;
		this.attr._Data[ii7].end=this.data.readUInt32LE(offset.value); offset.value+=4;
		this.attr._Data[ii7].data=this.data.readUInt32LE(offset.value); offset.value+=4;
	}
};
// 4.2.6. 컨트롤 헤더
...
root.record.TABLE = function Record_TABLE(data){
	...
	for(var ii8=0;ii8<this.attr.RowCount;ii8++){
		this.attr._RowSizes[ii8] = {};
		this.attr._RowSizes[ii8].value=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
...
root.record.SHAPE_COMPONENT = function Record_SHAPE_COMPONENT(data){
	...
	for(var ii9=0;ii9<this.attr.RenderingInfo._Count;ii9++){
		this.attr.RenderingInfo._ScaRotMatrices[ii9] = {};
		this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix = {};
	this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix.E1=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix.E2=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix.E3=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix.E4=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix.E5=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].ScaMatrix.E6=this.data.readDoubleLE(offset.value); offset.value+=8;
		this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix = {};
	this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix.E1=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix.E2=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix.E3=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix.E4=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix.E5=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii9].RotMatrix.E6=this.data.readDoubleLE(offset.value); offset.value+=8;
	}
	switch(''+(this.attr._Type)){
	case "$con":
	this.attr._Count=this.data.readUInt16LE(offset.value); offset.value+=2;
	this.attr._CTypes=[];
	for(var ii10=0;ii10<this.attr._Count;ii10++){
		this.attr._CTypes[ii10] = {};
		tmp=this.data.readUInt32LE(offset.value);this.attr._CTypes[ii10].value=String.fromCharCode(tmp>>24,tmp>>16&0xFF,tmp>>8&0xFF,tmp&0xFF); offset.value+=4;
	}
	...
	for(var ii11=0;ii11<this.attr.FillBrush.Gradation.ColorNum;ii11++){
		this.attr.FillBrush.Gradation._Colors[ii11] = {};
		this.attr.FillBrush.Gradation._Colors[ii11].value=this.data.readUInt32LE(offset.value); offset.value+=4;
	}
	// TODO
...
root.record.SHAPE_COMPONENT_POLYGON = function Record_SHAPE_COMPONENT_POLYGON(data){
	...
	for(var ii12=0;ii12<this.attr._Count;ii12++){
		this.attr._Points[ii12] = {};
		this.attr._Points[ii12].X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._Points[ii12].Y=this.data.readInt32LE(offset.value); offset.value+=4;
	}
...
root.record.SHAPE_COMPONENT_CURVE = function Record_SHAPE_COMPONENT_CURVE(data){
	...
	for(var ii13=0;ii13<this.attr._Count;ii13++){
		...
		this.attr._Points[ii13]._X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._Points[ii13]._Y=this.data.readInt32LE(offset.value); offset.value+=4;
	}
	this.attr._Count--;
	this.attr._Types=[];
	for(var ii14=0;ii14<this.attr._Count;ii14++){
		this.attr._Types[ii14] = {};
		this.attr._Types[ii14].value=this.data.readUInt8(offset.value);if(root.enum.SegmentType[this.attr._Types[ii14].value]!==undefined)this.attr._Types[ii14].value=root.enum.SegmentType[this.attr._Types[ii14].value]; offset.value+=1;
	}
	this.attr._Count++;
