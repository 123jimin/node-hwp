...
root.record.SHAPE_COMPONENT_POLYGON = function Record_SHAPE_COMPONENT_POLYGON(data){
	...
	for(var ii13=0;ii13<this.attr._Count;ii13++){
		this.attr._Points[ii13] = {};
		this.attr._Points[ii13].X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._Points[ii13].Y=this.data.readInt32LE(offset.value); offset.value+=4;
	}
...
root.record.SHAPE_COMPONENT_CURVE = function Record_SHAPE_COMPONENT_CURVE(data){
	...
	for(var ii14=0;ii14<this.attr._Count;ii14++){
		...
		this.attr._Points[ii14]._X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._Points[ii14]._Y=this.data.readInt32LE(offset.value); offset.value+=4;
	}
	this.attr._Count--;
	this.attr._Types=[];
	for(var ii15=0;ii15<this.attr._Count;ii15++){
		this.attr._Types[ii15] = {};
		this.attr._Types[ii15].value=this.data.readUInt8(offset.value);if(root.enum.SegmentType[this.attr._Types[ii15].value]!==undefined)this.attr._Types[ii15].value=root.enum.SegmentType[this.attr._Types[ii15].value]; offset.value+=1;
	}
	this.attr._Count++;
