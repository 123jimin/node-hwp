...
root.record.BORDER_FILL = function Record_BORDER_FILL(data){
	...
	this.attr.LeftBorder.value=this.data.readUInt32LE(4);
	...
	this.attr.RightBorder.value=this.data.readUInt32LE(10);
	this.attr.TopBorder = {};
	...
	this.attr.TopBorder.value=this.data.readUInt32LE(16);
	...
	this.attr.BottomBorder.value=this.data.readUInt32LE(22);
	this.attr.Diagonal = {};
	this.attr.Diagonal.Type=this.data.readUInt8(26);
