...
root.record.CTRL_HEADER = function Record_CTRL_HEADER(data){
	...
	// TODO: 적절한 이름 정하기
	tmp=this.data.readUInt32LE(0);this.attr.Type=String.fromCharCode(tmp>>24,tmp>>16&0xFF,tmp>>8&0xFF,tmp&0xFF);
	var offset={'value':4};switch(this.attr.Type){
	case "secd":this.attr.Type="SecDef";
	this.attr.Hide = {};
