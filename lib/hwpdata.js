...
root.node.CONTROLPOINT = function Node_CONTROLPOINT(){
	this.name = "CONTROLPOINT"; this.attr = {}; this.children = []; this.text_children = [];
	this.attr.Type = null;
	this.attr.X = null;
	this.attr.Y = null;
};
...
root.record.BORDER_FILL = function Record_BORDER_FILL(data){
	...
	this.attr.FillBrush = {};
	this.attr.FillBrush._BrushType=this.data.readUInt32LE(32);
	var offset={'value':36};switch(''+(this.attr.FillBrush._BrushType)){
	case "0":
	// TODO
	...
	this.attr.FillBrush.WindowBrush.HatchColor=this.data.readUInt32LE(offset.value); offset.value+=4;
	this.attr.FillBrush.WindowBrush.HatchStyle=this.data.readInt32LE(offset.value);if(root.enum.HatchStyle[this.attr.FillBrush.WindowBrush.HatchStyle]!==undefined)this.attr.FillBrush.WindowBrush.HatchStyle=root.enum.HatchStyle[this.attr.FillBrush.WindowBrush.HatchStyle]; offset.value+=4;
	// TODO
	this.attr.FillBrush.WindowBrush._Unknown=this.data.readInt32LE(offset.value); offset.value+=4;
	...
	for(var ii1=0;ii1<this.attr.FillBrush.Gradation.ColorNum;ii1++){
		this.attr.FillBrush.Gradation._Colors[ii1] = {};
		this.attr.FillBrush.Gradation._Colors[ii1].value=this.data.readUInt32LE(offset.value); offset.value+=4;
	}
	// TODO
	...
	break;
	default:
	console.warn("Warning [?>FillBrush]: not processing FillBrush Type '%s'", this.attr._BrushType);
	}
};
// 4.1.6. 글자 모양
root.record.CHAR_SHAPE = function Record_CHAR_SHAPE(data){
	var tmp; this.attr = {}; this.data = data; this.name = "CHAR_SHAPE";
	this.attr._FontIDs=[];var offset={'value':0};
	for(var ii2=0;ii2<7;ii2++){
		this.attr._FontIDs[ii2] = {};
		this.attr._FontIDs[ii2].value=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
	this.attr._FontRatios=[];
	for(var ii3=0;ii3<7;ii3++){
		this.attr._FontRatios[ii3] = {};
		this.attr._FontRatios[ii3].value=this.data.readUInt8(offset.value); offset.value+=1;
	}
	this.attr._FontCharSpacings=[];
	for(var ii4=0;ii4<7;ii4++){
		this.attr._FontCharSpacings[ii4] = {};
		this.attr._FontCharSpacings[ii4].value=this.data.readInt8(offset.value); offset.value+=1;
	}
	this.attr._FontRelSizes=[];
	for(var ii5=0;ii5<7;ii5++){
		this.attr._FontRelSizes[ii5] = {};
		this.attr._FontRelSizes[ii5].value=this.data.readUInt8(offset.value); offset.value+=1;
	}
	this.attr._FontCharOffsets=[];
	for(var ii6=0;ii6<7;ii6++){
		this.attr._FontCharOffsets[ii6] = {};
		this.attr._FontCharOffsets[ii6].value=this.data.readInt8(offset.value); offset.value+=1;
	}
	...
	this.attr._Italic=!!(tmp[0]&0x1);
	this.attr._Bold=!!((tmp[0]&0x2)>>1);
	this.attr.Underline.Type=((tmp[0]&0xc)>>2);if(root.enum.UnderlineType[this.attr.Underline.Type]!==undefined)this.attr.Underline.Type=root.enum.UnderlineType[this.attr.Underline.Type];
	this.attr.Underline.Shape=((tmp[0]&0xf0)>>4);if(root.enum.LineType2[this.attr.Underline.Shape]!==undefined)this.attr.Underline.Shape=root.enum.LineType2[this.attr.Underline.Shape];
	...
	this.attr._Emboss=!!((tmp[1]&0x20)>>5);
	this.attr._Engrave=!!((tmp[1]&0x40)>>6);
	this.attr._SuperScript=!!((tmp[1]&0x80)>>7);
	this.attr._SubScript=!!(tmp[2]&0x1);
	// 17: Reserved
	this.attr.Strikeout.Type=((tmp[2]&0x1c)>>2);if(root.enum.StrikeoutType[this.attr.Strikeout.Type]!==undefined)this.attr.Strikeout.Type=root.enum.StrikeoutType[this.attr.Strikeout.Type];
	// SymMark는 숫자임.
	this.attr.SymMark=((tmp[2]&0xe0)>>5)+((tmp[3]&0x1)<<3);
	this.attr.UseFontSpace=!!((tmp[3]&0x2)>>1);
	this.attr.Strikeout.Shape=((tmp[3]&0x3c)>>2);if(root.enum.LineType2[this.attr.Strikeout.Shape]!==undefined)this.attr.Strikeout.Shape=root.enum.LineType2[this.attr.Strikeout.Shape];
	...
	this.attr.Underline.Color=this.data.readUInt32LE(offset.value); offset.value+=4;
	...
	this.attr.Strikeout.Color=this.data.readUInt32LE(offset.value); offset.value+=4;
};
// 4.1.7 탭 정의
...
root.record.NUMBERING = function Record_NUMBERING(data){
	...
	for(var ii7=0;ii7<7;ii7++){
		this.attr.ParaHeads[ii7] = {};
		tmp=this.data.slice(offset.value,(offset.value+4)); offset.value+=4;
	this.attr.ParaHeads[ii7].Alignment=(tmp[0]&0x3);if(root.enum.AlignmentType2[this.attr.ParaHeads[ii7].Alignment]!==undefined)this.attr.ParaHeads[ii7].Alignment=root.enum.AlignmentType2[this.attr.ParaHeads[ii7].Alignment];
	this.attr.ParaHeads[ii7].UseInstWidth=!!((tmp[0]&0x4)>>2);
	this.attr.ParaHeads[ii7].AutoIndent=!!((tmp[0]&0x8)>>3);
	this.attr.ParaHeads[ii7].TextOffsetType=((tmp[0]&0x10)>>4);if(root.enum.TextOffsetType[this.attr.ParaHeads[ii7].TextOffsetType]!==undefined)this.attr.ParaHeads[ii7].TextOffsetType=root.enum.TextOffsetType[this.attr.ParaHeads[ii7].TextOffsetType];
	this.attr.ParaHeads[ii7].NumFormat=((tmp[0]&0xe0)>>5)+((tmp[1]&0x1)<<3);if(root.enum.NumberType1[this.attr.ParaHeads[ii7].NumFormat]!==undefined)this.attr.ParaHeads[ii7].NumFormat=root.enum.NumberType1[this.attr.ParaHeads[ii7].NumFormat];
		this.attr.ParaHeads[ii7].WidthAdjust=this.data.readUInt16LE(offset.value); offset.value+=2;
		this.attr.ParaHeads[ii7].TextOffset=this.data.readUInt16LE(offset.value); offset.value+=2;
		this.attr.ParaHeads[ii7].CharShape=this.data.readUInt32LE(offset.value); offset.value+=4;
		tmp=this.data.readUInt16LE(offset.value); offset.value+=2;for(this.attr.ParaHeads[ii7].value='';tmp-->0;){this.attr.ParaHeads[ii7].value+=String.fromCharCode(this.data.readUInt16LE(offset.value)); offset.value+=2;}
	}
...
root.record.PARA_RANGE_TAG = function Record_PARA_RANGE_TAG(data){
	...
	this.attr._Data=[];var offset={'value':0};
	for(var ii8=0;offset.value<this.data.length;ii8++){
		this.attr._Data[ii8] = {};
		this.attr._Data[ii8].start=this.data.readUInt32LE(offset.value); offset.value+=4;
		this.attr._Data[ii8].end=this.data.readUInt32LE(offset.value); offset.value+=4;
		this.attr._Data[ii8].data=this.data.readUInt32LE(offset.value); offset.value+=4;
	}
};
// 4.2.6. 컨트롤 헤더
...
root.record.LIST_HEADER = function Record_LIST_HEADER(data){
	...
	// 다른 객체(예: LIST_CELL)들이 이 레코드 뒤에 담겨 있는 듯.
...
root.record.TABLE = function Record_TABLE(data){
	...
	for(var ii9=0;ii9<this.attr.RowCount;ii9++){
		this.attr._RowSizes[ii9] = {};
		this.attr._RowSizes[ii9].value=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
...
root.record.SHAPE_COMPONENT = function Record_SHAPE_COMPONENT(data){
	...
	for(var ii10=0;ii10<this.attr.RenderingInfo._Count;ii10++){
		this.attr.RenderingInfo._ScaRotMatrices[ii10] = {};
		this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix = {};
	this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix.E1=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix.E2=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix.E3=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix.E4=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix.E5=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].ScaMatrix.E6=this.data.readDoubleLE(offset.value); offset.value+=8;
		this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix = {};
	this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix.E1=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix.E2=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix.E3=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix.E4=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix.E5=this.data.readDoubleLE(offset.value); offset.value+=8;
	this.attr.RenderingInfo._ScaRotMatrices[ii10].RotMatrix.E6=this.data.readDoubleLE(offset.value); offset.value+=8;
	}
	switch(''+(this.attr._Type)){
	case "$con":
	this.attr._Count=this.data.readUInt16LE(offset.value); offset.value+=2;
	this.attr._CTypes=[];
	for(var ii11=0;ii11<this.attr._Count;ii11++){
		this.attr._CTypes[ii11] = {};
		tmp=this.data.readUInt32LE(offset.value);this.attr._CTypes[ii11].value=String.fromCharCode(tmp>>24,tmp>>16&0xFF,tmp>>8&0xFF,tmp&0xFF); offset.value+=4;
	}
	...
	this.attr.LineShape._HeadFilled=!!((tmp[3]&0x40)>>6);
	this.attr.LineShape._TailFilled=!!((tmp[3]&0x80)>>7);
	var adjustArrSize = function adjustArrSize(x){
						if(this.attr.LineShape["_"+x+"Filled"]){
							var v = this.attr.LineShape[x+"Style"];
							if(v.slice(0,5) == "Empty"){
								this.attr.LineShape[x+"Style"] = "Filled"+v.slice(5);
							}
						}
					};
	...
	this.attr.FillBrush.Gradation.ColorNum=this.data.readUInt32LE(offset.value); offset.value+=4;
	this.attr.FillBrush.Gradation._Colors=[];
	for(var ii12=0;ii12<this.attr.FillBrush.Gradation.ColorNum;ii12++){
		this.attr.FillBrush.Gradation._Colors[ii12] = {};
		this.attr.FillBrush.Gradation._Colors[ii12].value=this.data.readUInt32LE(offset.value); offset.value+=4;
	}
	// TODO
	this.attr.FillBrush.Gradation._Unknown=this.data.readInt32LE(offset.value); offset.value+=4;
	this.attr.FillBrush.Gradation.StepCenter=this.data.readUInt8(offset.value); offset.value+=1;
...
root.record.SHAPE_COMPONENT_LINE = function Record_SHAPE_COMPONENT_LINE(data){
	...
	this.attr.IsReverseHV=!!(tmp[0]&0x1);
};
...
root.record.SHAPE_COMPONENT_CONNECTLINE = function Record_SHAPE_COMPONENT_CONNECTLINE(data){
	var tmp; this.attr = {}; this.data = data; this.name = "SHAPE_COMPONENT_CONNECTLINE";
	this.attr.StartX=this.data.readInt32LE(0);
	this.attr.StartY=this.data.readInt32LE(4);
	this.attr.EndX=this.data.readInt32LE(8);
	this.attr.EndY=this.data.readInt32LE(12);
	this.attr.Type=this.data.readInt32LE(16);
	this.attr.StartSubjectID=this.data.readUInt32LE(20);
	this.attr.StartSubjectIndex=this.data.readUInt32LE(24);
	this.attr.EndSubjectID=this.data.readUInt32LE(28);
	this.attr.EndSubjectIndex=this.data.readUInt32LE(32);
	this.attr._Count=this.data.readUInt32LE(36);
	this.attr._ControlPoints=[];var offset={'value':40};
	for(var ii13=0;ii13<this.attr._Count;ii13++){
		this.attr._ControlPoints[ii13] = {};
		this.attr._ControlPoints[ii13].X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._ControlPoints[ii13].Y=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._ControlPoints[ii13].Type=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
...
root.record.SHAPE_COMPONENT_POLYGON = function Record_SHAPE_COMPONENT_POLYGON(data){
	...
	// DOC: 32비트임
	this.attr._Count=this.data.readUInt32LE(0);
	// DOC: 이렇게 저장됨
	this.attr._Points=[];var offset={'value':4};
	for(var ii14=0;ii14<this.attr._Count;ii14++){
		this.attr._Points[ii14] = {};
		this.attr._Points[ii14].X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._Points[ii14].Y=this.data.readInt32LE(offset.value); offset.value+=4;
	}
	// TODO_SOMETIME: 뒤에 뭐가 더 있는 것 같음 (4바이트)
};
// 4.2.9.2.6. 호 개체
...
root.record.SHAPE_COMPONENT_CURVE = function Record_SHAPE_COMPONENT_CURVE(data){
	...
	// DOC: 이렇게 저장됨
	this.attr._Points=[];var offset={'value':4};
	for(var ii15=0;ii15<this.attr._Count;ii15++){
		this.attr._Points[ii15] = {};
		this.attr._Points[ii15]._X=this.data.readInt32LE(offset.value); offset.value+=4;
		this.attr._Points[ii15]._Y=this.data.readInt32LE(offset.value); offset.value+=4;
	}
	this.attr._Count--;
	this.attr._Types=[];
	for(var ii16=0;ii16<this.attr._Count;ii16++){
		this.attr._Types[ii16] = {};
		this.attr._Types[ii16].value=this.data.readUInt8(offset.value);if(root.enum.SegmentType[this.attr._Types[ii16].value]!==undefined)this.attr._Types[ii16].value=root.enum.SegmentType[this.attr._Types[ii16].value]; offset.value+=1;
	}
	this.attr._Count++;
