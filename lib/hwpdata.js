...
root.record.TABLE = function Record_TABLE(data){
	...
	this.attr.RowSizes=[];var offset={'value':18};
	for(var ii0=0;ii0<this.attr.RowCount;ii0++){
		this.attr.RowSizes[ii0] = {};
		this.attr.RowSizes[ii0].value=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
...
root.record.FOOTNOTE_SHAPE = function Record_FOOTNOTE_SHAPE(data){
	...
	// 문서가 틀림!
	this.attr.NoteLine.Length=this.data.readUInt32LE(12);
