...
root.record.BIN_DATA = function Record_BIN_DATA(data){
	...
	attr.Property=this.data.readUInt16LE(0);
};
// 4.1.4. 글꼴
...
root.record.CTRL_HEADER = function Record_CTRL_HEADER(data){
	...
	attr.ShapeObject.Position.VertOffset=this.data.readUInt32LE(offset.value); offset.value+=4;
	attr.ShapeObject.Position.HorzOffset=this.data.readUInt32LE(offset.value); offset.value+=4;
...
root.record.SHAPE_COMPONENT = function Record_SHAPE_COMPONENT(data){
	...
	attr.OriWidth=this.data.readUInt32LE(offset.value); offset.value+=4;
	attr.OriHeight=this.data.readUInt32LE(offset.value); offset.value+=4;
	attr.CurWidth=this.data.readUInt32LE(offset.value); offset.value+=4;
	attr.CurHeight=this.data.readUInt32LE(offset.value); offset.value+=4;
	tmp=this.data.slice(offset.value,(offset.value+4)); offset.value+=4;
...
root.record.SHAPE_COMPONENT_ELLIPSE = function Record_SHAPE_COMPONENT_ELLIPSE(data){
	...
	attr.ArcType=((tmp[0]&0xfc)>>2)+((tmp[1]&0x3)<<6);if(root.enum.ArcType[attr.ArcType]!==undefined)attr.ArcType=root.enum.ArcType[attr.ArcType];
