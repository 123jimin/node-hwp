...
root.record.CHAR_SHAPE = function Record_CHAR_SHAPE(data){
	...
	for(var ii1=0;ii1<7;ii1++){
		this.attr.FontIDs[ii1] = {};
		this.attr.FontIDs[ii1].value=this.data.readUInt16LE(offset.value); offset.value+=2;
	}
	this.attr.FontRatios=[];
	for(var ii2=0;ii2<7;ii2++){
		this.attr.FontRatios[ii2] = {};
		this.attr.FontRatios[ii2].value=this.data.readUInt8(offset.value); offset.value+=1;
	}
	this.attr.FontCharSpacings=[];
	for(var ii3=0;ii3<7;ii3++){
		this.attr.FontCharSpacings[ii3] = {};
		this.attr.FontCharSpacings[ii3].value=this.data.readInt8(offset.value); offset.value+=1;
	}
	this.attr.FontRelSizes=[];
	for(var ii4=0;ii4<7;ii4++){
		this.attr.FontRelSizes[ii4] = {};
		this.attr.FontRelSizes[ii4].value=this.data.readUInt8(offset.value); offset.value+=1;
	}
	this.attr.FontCharOffsets=[];
	for(var ii5=0;ii5<7;ii5++){
		this.attr.FontCharOffsets[ii5] = {};
		this.attr.FontCharOffsets[ii5].value=this.data.readInt8(offset.value); offset.value+=1;
	}
